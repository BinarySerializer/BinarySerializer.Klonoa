namespace BinarySerializer.Klonoa.KH
{
    public class MenuPack_MamettHouse_ArchiveFile : PF_ArchiveFile
    {
        ...
        protected override void SerializeFiles(SerializerObject s)
        {
            ...
            File_3 = SerializeFile<TextCommands_File>(s, File_3, 3, name: nameof(File_3));

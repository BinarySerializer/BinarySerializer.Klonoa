...
namespace BinarySerializer.Klonoa.KH
{
    public class KlonoaHeroesROM : GBA_ROMBase
    {
        ...
        public EnemyObjectTypeDefinition[] MapObjectTypes { get; set; }
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            s.DoAt(new Pointer(0x08068720, Offset.File), () => MapObjectTypes = s.SerializeObjectArray<EnemyObjectTypeDefinition>(MapObjectTypes, 182, name: nameof(MapObjectTypes)));
        }
    }
}
namespace BinarySerializer.KlonoaDTP
{
    public class CutscenePack_ArchiveFile : BaseArchiveFile
    {
        ...
        public RawData_File FontImgData { get; set; } // Raw image data, gets loaded at (0x3f4, 0x180, 0xc, 0x80)
        ...
        protected override void SerializeFiles(SerializerObject s)
        {
            ...
            FontImgData = SerializeFile<RawData_File>(s, FontImgData, 3, name: nameof(FontImgData));

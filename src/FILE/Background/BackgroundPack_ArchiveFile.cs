...
namespace BinarySerializer.KlonoaDTP
{
    ...
    public class BackgroundPack_ArchiveFile : ArchiveFile
    {
        ...
        public ArchiveFile<TileAnimations_File> TileAnimationFiles { get; set; }
        ...
        protected override void SerializeFiles(SerializerObject s)
        {
            ...
            TileAnimationFiles = SerializeFile<ArchiveFile<TileAnimations_File>>(s, TileAnimationFiles, 3, name: nameof(TileAnimationFiles));
        }
    }
}
namespace BinarySerializer.Klonoa.LV
{
    ...
    {
        public RawData_File Descriptor { get; set; } // Not sure what this file is for, but let's just assume it's some sort of descriptor given its position in the archive

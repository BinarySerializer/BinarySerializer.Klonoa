namespace BinarySerializer.Klonoa.LV
{
    public class KCM_File : BaseFile
    {
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            FollowCameras = s.SerializeObjectArrayUntil<FollowCamera>(FollowCameras, (c) => (c.Flag & 128) != 0, name: nameof(FollowCameras));

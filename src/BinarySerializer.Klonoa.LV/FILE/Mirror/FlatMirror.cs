namespace BinarySerializer.Klonoa.LV
{
    public class FlatMirror : BinarySerializable
    {
        ...
        public Pointer VectorOffset { get; set; }
        ...
        public KlonoaLV_FloatVector[] Vertex { get; set; }


        public override void SerializeImpl(SerializerObject s)
        {
            VectorOffset = s.SerializePointer(VectorOffset, anchor: Pre_Anchor, name: nameof(VectorOffset));
            ...
            s.DoAt(VectorOffset, () => {
                ...
                Vertex = s.SerializeObjectArray<KlonoaLV_FloatVector>(Vertex, 4, name: nameof(Vertex), onPreSerialize: x => x.Pre_HasW = true);
            });
        }
    }
}
namespace BinarySerializer.Klonoa.LV
{
    ...
    {
        public GMS_File Textures { get; set; } // Compressed GSTextures
        public VPM_File Geometry { get; set; } // Compressed VIF codes
        public RT_File RouteData { get; set; }
        public RawData_File CollisionData { get; set; }
        public KCM_File CameraData { get; set; }
        public LGT_File LightData { get; set; }

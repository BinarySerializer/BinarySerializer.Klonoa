...
namespace BinarySerializer.Klonoa.LV
{
    public class CutsceneCommand : BinarySerializable, ISerializerShortLog
    {
        ...
        #region Data
        public CutsceneCommandData32A Data32A { get; set; }
        public CutsceneCommandData32B Data32B { get; set; }
        public CutsceneCommandData64A Data64A { get; set; }
        public CutsceneCommandData64B Data64B { get; set; }
        public CutsceneCommandData64C Data64C { get; set; }
        public CutsceneCommandData64D Data64D { get; set; }
        public CutsceneCommandData64E Data64E { get; set; }
        public CutsceneCommandData64F Data64F { get; set; }
        public CutsceneCommandData96A Data96A { get; set; }
        public CutsceneCommandData96B Data96B { get; set; }
        public CutsceneCommandData96C Data96C { get; set; }
        public CutsceneCommandData96D Data96D { get; set; }
        public CutsceneCommandData96E Data96E { get; set; }
        public CutsceneCommandData96F Data96F { get; set; }
        public CutsceneCommandData128A Data128A { get; set; }
        public CutsceneCommandData128B Data128B { get; set; }
        public CutsceneCommandData128C Data128C { get; set; }
        public CutsceneCommandData160A Data160A { get; set; }
        #endregion
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            switch (Type)
            {
                ...
                case CommandType.Control_Type:
                    Data64A = s.SerializeObject<CutsceneCommandData64A>(Data64A, name: nameof(Data64A));
                    break;
                ...
                case CommandType.Control_Flag:
                    Data96A = s.SerializeObject<CutsceneCommandData96A>(Data96A, name: nameof(Data96A));
                    break;
                ...
                case CommandType.Control_PositionMV:
                    Data128B = s.SerializeObject<CutsceneCommandData128B>(Data128B, name: nameof(Data128B));
                    break;
                ...
                case CommandType.Control_Scale:
                    Data64C = s.SerializeObject<CutsceneCommandData64C>(Data64C, name: nameof(Data64C));
                    break;
                ...
                case CommandType.Control_Col:
                    Data64E = s.SerializeObject<CutsceneCommandData64E>(Data64E, name: nameof(Data64E));
                    break;
                ...
                case CommandType.Control_PositionMVPC:
                    Data160A = s.SerializeObject<CutsceneCommandData160A>(Data160A, name: nameof(Data160A));
                    break;
                ...
                case CommandType.Control_FogNear:
                    Data64B = s.SerializeObject<CutsceneCommandData64B>(Data64B, name: nameof(Data64B));
                    break;
                ...
                case CommandType.Camera_LenMVP:
                    Data64F = s.SerializeObject<CutsceneCommandData64F>(Data64F, name: nameof(Data64F));
                    break;
                ...
                case CommandType.Game_RtMV:
                    Data64D = s.SerializeObject<CutsceneCommandData64D>(Data64D, name: nameof(Data64D));
                    break;
                ...
                case CommandType.Game_PosJ:
                    Data96B = s.SerializeObject<CutsceneCommandData96B>(Data96B, name: nameof(Data96B));
                    break;
                case CommandType.Game_Key:
                    Data64B = s.SerializeObject<CutsceneCommandData64B>(Data64B, name: nameof(Data64B));
                    break;
                case CommandType.Game_RtJump:
                    Data128C = s.SerializeObject<CutsceneCommandData128C>(Data128C, name: nameof(Data128C));
                    break;

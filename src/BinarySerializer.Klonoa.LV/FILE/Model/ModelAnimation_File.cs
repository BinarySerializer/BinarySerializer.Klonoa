...
{
    public class ModelAnimation_File : BaseFile
    {
        ...
        #region Morph Data
        public ModelAnimation_MorphData MorphData { get; set; }
        #endregion
        ...
        public ModelAnimation_InterpolatedKeyframes[] TranslationKeyframes { get; set; }
        public ModelAnimation_InterpolatedKeyframes[] RotationKeyframes { get; set; }
        #endregion
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            if (HasMorphAnimation) {
                s.DoAt(MorphAnimationPointer, () => {
                    MorphData = s.SerializeObject<ModelAnimation_MorphData>(MorphData, name: nameof(MorphData));
                });
            } else {
                s.SerializePadding(4, logIfNotNull: true);
            }
            ...
            if (IsInterpolated) {
                s.DoAt(KeyframesPointer, () => {
                    ...
                    TranslationKeyframes = s.SerializeObjectArray<ModelAnimation_InterpolatedKeyframes>(TranslationKeyframes, TranslationCount, name: nameof(TranslationKeyframes));
                    RotationKeyframes = s.SerializeObjectArray<ModelAnimation_InterpolatedKeyframes>(RotationKeyframes, RotationCount, name: nameof(RotationKeyframes));
                });
            } else {

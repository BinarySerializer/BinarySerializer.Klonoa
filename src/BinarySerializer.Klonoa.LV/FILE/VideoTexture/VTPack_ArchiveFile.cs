namespace BinarySerializer.Klonoa.LV
{
    ...
    public class VTPack_ArchiveFile : ArchiveFile
    {
        ...
        public WDT_File[] Waves { get; set; }
        public SDT_File[] Sprays { get; set; } // Only used in Sea of Tears
        public RawData_File DummyFile { get; set; }

        protected override void SerializeFiles(SerializerObject s)
        {
            Sprays = new SDT_File[Pre_SectorCount]; // One spray max per sector
            Waves = new WDT_File[Pre_SectorCount]; // One wave max per sector

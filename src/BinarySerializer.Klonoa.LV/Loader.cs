...
namespace BinarySerializer.Klonoa.LV
{
    public class Loader : BaseLoader
    {
        ...
        protected Loader(Context context, HeadPack_ArchiveFile headPack) : base(context)
        {
            HeadPack = headPack;
        }
        ...
        /// <returns>The loader</returns>
        public static Loader Create(Context context, HeadPack_ArchiveFile headPack)
        {
            ...
            // Create the loader
            var loader = new Loader(context, headPack);

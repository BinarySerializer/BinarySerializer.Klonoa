...
namespace BinarySerializer.Klonoa.KH
{
    public class CutsceneCommand : BinarySerializable
    {
        ...
        // Unknown arguments
        public ushort Arg1_Ushort { get; set; }
        public bool Arg1_Bool { get; set; }
        public ushort Arg2_Ushort { get; set; }
        public bool Arg2_Bool { get; set; }
        public ushort Arg3_Ushort { get; set; }
        public ushort Arg4_Ushort { get; set; }
        public uint Arg4_Uint { get; set; }
        public ushort Arg5_Ushort { get; set; }
        public ushort Arg_Padding { get; set; }
        
        // Generic arguments
        public ushort CommandOffset1 { get; set; } // Value * 2
        public ushort CommandOffset2 { get; set; } // Value * 2
        ...
        public ushort FileIndex_0 { get; set; }
        public ushort FileIndex_1 { get; set; }
        public ushort FileIndex_2 { get; set; }
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            switch (Type)
            {
                case CommandType.CMD_00_00: // Interacts with some other cutscene
                    CommandOffset1 = s.Serialize<ushort>(CommandOffset1, name: nameof(CommandOffset1));
                    break;
                ...
                case CommandType.Wait:
                    Frames = s.Serialize<ushort>(Frames, name: nameof(Frames));
                    EndOfFrame = true;
                    break;
                ...
                case CommandType.CMD_00_08:
                    Arg1_Ushort = s.Serialize<ushort>(Arg1_Ushort, name: nameof(Arg1_Ushort));
                    Arg2_Ushort = s.Serialize<ushort>(Arg2_Ushort, name: nameof(Arg2_Ushort));
                    Arg3_Ushort = s.Serialize<ushort>(Arg3_Ushort, name: nameof(Arg3_Ushort));
                    Arg4_Ushort = s.Serialize<ushort>(Arg4_Ushort, name: nameof(Arg4_Ushort));
                    Arg5_Ushort = s.Serialize<ushort>(Arg5_Ushort, name: nameof(Arg5_Ushort));
                    break;
                ...
                case CommandType.CMD_00_16:
                    Arg1_Ushort = s.Serialize<ushort>(Arg1_Ushort, name: nameof(Arg1_Ushort)); // Offset to some temp buffer with two values
                    Arg2_Ushort = s.Serialize<ushort>(Arg2_Ushort, name: nameof(Arg2_Ushort)); // The value to set the temp buffer value to if 0, otherwise decrease
                    CommandOffset1 = s.Serialize<ushort>(CommandOffset1, name: nameof(CommandOffset1));
                    break;
                ...
                case CommandType.ConditionalGoTo_2:
                    InvertCondition = s.Serialize<bool>(InvertCondition, name: nameof(InvertCondition));
                    s.SerializePadding(1);
                    Arg2_Ushort = s.Serialize<ushort>(Arg2_Ushort, name: nameof(Arg2_Ushort)); // Checks if this value equals some other value in memory
                    s.SerializePadding(1);
                    CommandOffset1 = s.Serialize<ushort>(CommandOffset1, name: nameof(CommandOffset1));
                    break;
                ...
                case CommandType.ConditionalGoTo_3:
                    InvertCondition = s.Serialize<bool>(InvertCondition, name: nameof(InvertCondition));
                    s.SerializePadding(1);
                    Arg2_Ushort = s.Serialize<ushort>(Arg2_Ushort, name: nameof(Arg2_Ushort)); // Value used to determine condition
                    s.SerializePadding(1);
                    CommandOffset1 = s.Serialize<ushort>(CommandOffset1, name: nameof(CommandOffset1));
                    break;
                ...
                case CommandType.ConditionalMultiGoTo: // Conditionally go to either one or none
                    CommandOffset1 = s.Serialize<ushort>(CommandOffset1, name: nameof(CommandOffset1));
                    CommandOffset2 = s.Serialize<ushort>(CommandOffset2, name: nameof(CommandOffset2));
                    break;
                ...
                case CommandType.CMD_03_24:
                    FileIndex_0 = s.Serialize<ushort>(FileIndex_0, name: nameof(FileIndex_0));
                    FileIndex_1 = s.Serialize<ushort>(FileIndex_1, name: nameof(FileIndex_1));
                    break;

                case CommandType.CMD_03_25:
                    Arg1_Ushort = s.Serialize<ushort>(Arg1_Ushort, name: nameof(Arg1_Ushort)); // If 2 it loads graphics
                    break;
            ...
            {
                Arg_Padding = s.Serialize<ushort>(Arg_Padding, name: nameof(Arg_Padding));

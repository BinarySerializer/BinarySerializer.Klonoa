namespace BinarySerializer.Klonoa.KH
{
    public class StoryPack_ArchiveFile : ArchiveFile
    {
        ...
        public ArchiveFile<ArchiveFile<ArchiveFile<TextCommands>>> File_12 { get; set; }
        ...
        protected override void SerializeFiles(SerializerObject s)
        {
            ...
            File_12 = SerializeFile<ArchiveFile<ArchiveFile<ArchiveFile<TextCommands>>>>(s, File_12, 12, name: nameof(File_12));

namespace BinarySerializer.Klonoa.KH
{
    public class UIPack_File76_ArchiveFile : ArchiveFile
    {
        ...
        public RawData_File File_8 { get; set; }
        public RawData_File File_9 { get; set; }
        public RawData_File File_10 { get; set; }
        public RawData_File File_11 { get; set; }
        public RawData_File File_12 { get; set; }
        public RawData_File File_13 { get; set; }
        ...
        public RawData_File File_20 { get; set; }
        public RawData_File File_21 { get; set; }
        public RawData_File File_22 { get; set; }
        public RawData_File File_23 { get; set; }
        public RawData_File File_24 { get; set; }
        public RawData_File File_25 { get; set; }
        public RawData_File File_26 { get; set; }
        public RawData_File File_27 { get; set; }
        public RawData_File File_28 { get; set; }
        public RawData_File File_29 { get; set; }
        public RawData_File File_30 { get; set; }
        public RawData_File File_31 { get; set; }
        ...
        protected override void SerializeFiles(SerializerObject s)
        {
            ...
            File_8 = SerializeFile<RawData_File>(s, File_8, 8, name: nameof(File_8));
            File_9 = SerializeFile<RawData_File>(s, File_9, 9, name: nameof(File_9));
            File_10 = SerializeFile<RawData_File>(s, File_10, 10, name: nameof(File_10));
            File_11 = SerializeFile<RawData_File>(s, File_11, 11, name: nameof(File_11));
            File_12 = SerializeFile<RawData_File>(s, File_12, 12, name: nameof(File_12));
            File_13 = SerializeFile<RawData_File>(s, File_13, 13, name: nameof(File_13));
            ...
            File_20 = SerializeFile<RawData_File>(s, File_20, 20, name: nameof(File_20));
            File_21 = SerializeFile<RawData_File>(s, File_21, 21, name: nameof(File_21));
            File_22 = SerializeFile<RawData_File>(s, File_22, 22, name: nameof(File_22));
            File_23 = SerializeFile<RawData_File>(s, File_23, 23, name: nameof(File_23));
            File_24 = SerializeFile<RawData_File>(s, File_24, 24, name: nameof(File_24));
            File_25 = SerializeFile<RawData_File>(s, File_25, 25, name: nameof(File_25));
            File_26 = SerializeFile<RawData_File>(s, File_26, 26, name: nameof(File_26));
            File_27 = SerializeFile<RawData_File>(s, File_27, 27, name: nameof(File_27));
            File_28 = SerializeFile<RawData_File>(s, File_28, 28, name: nameof(File_28));
            File_29 = SerializeFile<RawData_File>(s, File_29, 29, name: nameof(File_29));
            File_30 = SerializeFile<RawData_File>(s, File_30, 30, name: nameof(File_30));
            File_31 = SerializeFile<RawData_File>(s, File_31, 31, name: nameof(File_31));
        }
    }
}
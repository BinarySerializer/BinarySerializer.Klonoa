namespace BinarySerializer.Klonoa.LV
{
    ...
    /// </summary>
    public class ModelSkinDescriptor : BinarySerializable
    {
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            s.DoAt(VertexWeightsPointer, () => VertexWeights = s.SerializeObjectArray<ModelVertexWeight>(VertexWeights, VertexCount, name: nameof(VertexWeights)));
        }
    }
}